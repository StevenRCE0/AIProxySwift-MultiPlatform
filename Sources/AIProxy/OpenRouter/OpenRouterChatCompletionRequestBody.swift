...
nonisolated public struct OpenRouterChatCompletionRequestBody: Encodable, Sendable {
    ...
    /// Required when requesting audio output from audio-capable models like `gpt-audio`.
    ...
    public init(
        ...
        audio: OpenRouterChatCompletionRequestBody.AudioOutputConfig? = nil
    ) {
...
extension OpenRouterChatCompletionRequestBody {
    nonisolated public enum Message: Encodable, Sendable {
        ...
        case assistant(content: AssistantContent, name: String? = nil, audio: AudioReference? = nil)
        ...
        public func encode(to encoder: any Encoder) throws {
            ...
            switch self {
            case .assistant(let content, let name, let audio):
